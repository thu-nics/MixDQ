...
public:
  ...
  using Base = GemmUniversal<Mma_,Epilogue_, ThreadblockSwizzle>;
  ...
  static int const kAlignmentA = Base::kAlignmentA;
  static int const kAlignmentB = Base::kAlignmentB;
  static int const kAlignmentC = Base::kAlignmentC;
