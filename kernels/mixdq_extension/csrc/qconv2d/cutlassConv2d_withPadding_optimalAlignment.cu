...
static const int MainLoopStages = 4;
...
using Bias0 = cutlass::epilogue::threadblock::VisitorAuxLoad<
    OutputTileThreadMap, float, cute::Stride<int64_t, cute::_1, cute::_0>
>;
...
typename EVTDNoBias::Arguments get_callback_args(
    ...
    typename EVTDNoBias::Arguments callback_args{            
        {   
            {
                {},                                                             // Accum
                {Bias0_data, float(0), {ldD, cute::_1{}, cute::_0{}}},   // Bias0
                {}                                                              // Compute0
            },                                                                  // EVTCompute0
